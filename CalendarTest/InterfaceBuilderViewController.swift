...
class InterfaceBuilderViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, FSCalendarDataSource, FSCalendarDelegate, FSCalendarDelegateAppearance{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: DairyTableViewCell = self.tableView.dequeueReusableCell(withIdentifier: "cell") as! DairyTableViewCell
        //利用日记数据创建字典
